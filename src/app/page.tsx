                ...
                <div className="glass-panel rounded-xl p-4 border border-white/10 hover:border-primary/30 transition-all group cursor-pointer">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-primary/20 flex items-center justify-center flex-shrink-0">
                      <span className="font-headline font-black text-primary-container">{index === 2 ? '🚘' : biz.name.charAt(0)}</span>
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="font-headline font-bold text-white text-sm truncate group-hover:text-primary-container transition-colors">
                    ...
                    <div className="flex items-center gap-1">
                      {index === 2 ? (
                        <span className="text-xs font-bold text-primary-container">→</span>
                      ) : (
                        <>
